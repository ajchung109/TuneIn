...
function genSong(word, dayToday) {
  ...
  .then((data) => {
    ...
    //maybe update dictionary of var day here??? figure out how to access attributes of song and use that to update entries "song" & "song-link" based on day 
    //use if loop to check which day?? 
